                    ...
                    <div class="col-lg-8 col-xl-12">
                        <div class="card rounded-3">
                            <div class="container-xxl py-10">
                                <div class="container">
                                    <h4 class="mb-2 pb-2 pb-md-0 mb-md-2 px-md-2">Registrar Taller o Conferencia</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control border border-primary" id="titulo" name="titulo" required oninput="this.value = this.value.toUpperCase()" focus>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="aula" name="aula" required oninput="this.value = this.value.toUpperCase()">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control border border-primary" id="souvenir" name="souvenir" required oninput="this.value = this.value.toUpperCase()">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
...
if (isset($_POST['submit'])) {
    $registro = ControladorFormulariosMaestros::ctrRegistroCurso();
