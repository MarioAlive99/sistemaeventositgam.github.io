               ...
               <div class="form-group">
                        <div class="row">
                            <div class="col">
                                ...
                                <div style="margin-top: 10px;">
                                    <a href="index.php?pagina=AdminAreaPagosAlumnas" class="btn btn-dark">Alumnas Cuota Pagada</a>
                                </div>
                                <div style="margin-top: 10px;">
...
<div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;"></div>
 ...
 <?php  
   $resultado = ControladorFormulariosPagos::ctrSeleccionarTotalTallaMujeres();
 ...
 ?>
<div class="form-group">
    <h3>Alumnas inscritas con cuota pagada</h3>
    <h5>Totales de tallas Mujeres</h5>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tbody class="tbody-td">
            ...
            $talleres = ControladorFormulariosPagos::ctrSeleccionarPagosMujeres(); // Obtener los talleres desde el controlador
