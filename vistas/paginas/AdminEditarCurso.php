                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control border border-primary" id="nombre_profesor" name="nombre_profesor" readonly value="<?php echo $usuario["numero_control_profesor"]; ?>" oninput="this.value = this.value.toUpperCase()">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="nombre_profesor" style="font-weight: bold; color: #1b396a;">Nombre del Profesor</label>
                                                    <input type="text" class="form-control border border-primary" id="nombre_profesor" name="nombre_profesor" readonly value="<?php echo $usuario["nombre_profesor"]; ?>" oninput="this.value = this.value.toUpperCase()">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
...
if (isset($_POST['submit'])) {
    ...
    if ($registro == "Curso registrado correctamente.") {
        ...
        echo '<script>alert("¡Registro exitoso!"); window.location.href ="index.php?pagina=AdminAreaCursos";</script>';
    } else {
