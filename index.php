...
require_once "controladores/formulariosM.controlador.php";
require_once "modelos/formulariosM.modelo.php";

require_once "controladores/formulariosA.controlador.php";
require_once "modelos/formulariosA.modelo.php";

require_once "controladores/formulariosP.controlador.php";
require_once "modelos/formulariosP.modelo.php";
